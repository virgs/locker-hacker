...
1. [x] I don't like the how the of number of guess attempts looks like. Make it look nicer and more intuitive. Maybe a progress bar or something like that? Or an icon that fills up? Or a combination of both? Explore some options and implement the best one. Use bootswatch theme for styling.
2. [x] On the visual clue in the footer that tells the code length, let's make it more intuitive. The visual clue should update to show how many dots are currently selected and how many are left to select. For example, if the code length is 4 and the user has selected 2 dots, the visual clue should indicate "2/4" or something similar to show that 2 dots are selected and 2 more need to be selected to complete the code. This way, users will have a clearer understanding of their progress in selecting the correct code. When no dots are selected, it should show "0/4" and it should keep the current neutral color. When some dots are selected, but the number of selected dots is different than the code length, it should change to a warning color (bootswatrap warning). When the number of selected dots equals the code length, it should show "4/4" and it should change to a success color (bootstrap success). When the user finishes the guess, it should preserve the last state of the visual clue for a moment (maybe 2 seconds), change the color to red (bootstrap danger) before resetting it back to "0/4" and the neutral color. This way, users will have a clear visual indication of their progress in selecting the correct code and will be able to easily see when they have selected the correct number of dots. This way, users will have a clear visual indication of their progress in selecting the correct code and will be able to easily see when they have selected the correct number of dots. Use bootswatch theme for styling.