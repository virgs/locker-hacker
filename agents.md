...
1. [x]  When the annotation menu is on, I can clearly see what I think is the area wrapped by ".pattern-lock-focus-layer". Maybe it's being dimmed/darkened twice. That shouldn't happen.
