...
1. [ ] I want to add the open graph meta tags to the index.html file to improve the appearance of shared links on social media platforms. This will help attract more users to the game and increase engagement. Use the screenshot from the README as the og:image, and write a compelling description for the og:description tag.
